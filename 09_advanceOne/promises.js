...
/**There was a library called Bluebird which was composed of promises and other asynchronous features and it
 was integrated with ES6 later on. **/
...
const promiseOne = new Promise( (resolve,reject) => {
    ...
    setTimeout(()=>{
       ...
       resolve() // Resolve se hi promiseOne.then run hoga
    }, 1000)
...
consumePromise(); // Call the function
